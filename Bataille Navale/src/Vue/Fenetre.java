	...
	public void affichage() {
		{
			...
			demarrer.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					int response = JOptionPane.showOptionDialog(null,
							"Voulez-vous lancer en mode Console ou Graphique ?", "Lancer une nouvelle partie",
							JOptionPane.DEFAULT_OPTION, JOptionPane.PLAIN_MESSAGE, null, options, options[0]);
					if (response == 1) {
						if (!grilleConsoleIsSet) {
							if (grilleIsSet == false) {
								...
								int reply = JOptionPane.showConfirmDialog(null,
										"Etes-vous sûr de vouloir lancer une nouvelle partie ?",
										"Lancer une nouvelle partie", JOptionPane.YES_NO_OPTION);
								if (reply == JOptionPane.YES_OPTION) {
									...
									g.AddBateauIA();
									grilleIsSet = true;
									BatailleNavale.setPlay(true);
								}
							}
						} else {
							System.out.println(
									"Vous ne pouvez lancer une partie sur console, une partie graphique est en cours");
						}
					}
					if (response == 0) {
						if (!grilleIsSet) {
			...
			quitter.addActionListener(new ActionListener() {
				@Override
				public void actionPerformed(ActionEvent e) {
					int reply = JOptionPane.showConfirmDialog(null, "Etes-vous sûr de vouloir quitter ?",
							"Quitter le jeu", JOptionPane.YES_NO_OPTION);
					if (reply == JOptionPane.YES_OPTION) {
						int reply1 = JOptionPane.showConfirmDialog(null, "Voulez vous sauvegarder avant de quitter ?",
								"Quitter le jeu", JOptionPane.YES_NO_OPTION);
			...
			save.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					int reply = JOptionPane.showConfirmDialog(null,
							"Etes-vous sûr de vouloir sauvegarder votre partie ? Cela écrasera toute sauvegarde",
							"Sauvegarder votre partie", JOptionPane.YES_NO_OPTION);
					if (reply == JOptionPane.YES_OPTION) {
						SaveGrille();
					}
				}
			...
			chargersave.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					int reply = JOptionPane.showConfirmDialog(null,
							"Etes-vous sûr de vouloir charger la partie ? Cela écrasera votre partie actuelle",
							"Charger une nouvelle partie", JOptionPane.YES_NO_OPTION);
					if (reply == JOptionPane.YES_OPTION) {
						chargerSave();
					}
				}
